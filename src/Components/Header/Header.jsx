...
const Header = () => {
    return (
        <div className='banner w-full md:h-screen  md:pl-56 md:pt-28 ' >
            <div className="md:w-8/12 mx-auto bg-gradient-to-r from-slate-50 p-12 rounded-lg">
                <h1 className='md:text-6xl text-3xl'>Best Children <span className='text-blue-900 animate-pulse font-bold'> Animals Toys</span> Project !!</h1>
